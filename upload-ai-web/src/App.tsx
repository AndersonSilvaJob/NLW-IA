   ...
   <div className="min-h-screen flex flex-col">
    <div className="px-6 py-3 flex items-center justify-between border-b">
      ...
      <div className="flex items-center gap-3">
        <span className="text-sm text-zinc-foreground">
    ...
    <main className="flex-1 p-6 flex gap-6">
      <div className="flex flex-col flex-1 gap-4">
        ...
        <p className="text-sm text-muted-foreground">
          Lembre-se: você pode utilizar a variável <code className="text-violet-400">{'{transcription}'}</code> no seu prompt para adcionar o conteúdo da transcrição do video selecionado.
        </p>
      </div>
     ...
     <aside className="w-80 space-y-6">
      <form className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          placeholder="Inclua palavras-chave mencionadas no video separado por virgula(,)"
          />
        </div>
